  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/Total Bayar' :(BuildContext context) => new ProgramMatematika(),
      },
      ...
      body: new Column(
        children: <Widget>[
          new ListTile(
            ...
            title: const Text('ARFAN ADAM NST'),
          ),
          new ListTile(
           ...
           new ListTile(
            ...
            title: const Text('Jl. DELITUA GG. AMAN NO 30'),
             ),
           new ListTile(
      ...
      body: Container(
        ...
        child: Column(
         ...
         decoration: InputDecoration(labelText: "Input Nama Barang"),
             ...
             TextField(
              controller: _jumlah,
              decoration: InputDecoration(labelText: "Input Jumlah"),
            ),
            TextField(
              controller: _harga,
              decoration: InputDecoration(labelText: "Input Harga"),
            ),
            ElevatedButton(
              child: Text("Hitung"),
              onPressed: onHitung,
